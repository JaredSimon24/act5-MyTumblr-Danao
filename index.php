...
$acc_username = "SimonJared";
$acc_password = "simonjared#24";
$acc_fullname = "Jared Simon Danao";
		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-5">
		      	...
		      	<h3 class="text-center mb-4">MyTumblr Login</h3>
                      ...
                      echo "<div class='alert alert-info' role='alert'> Thank You...</div>";
                       ...
                       echo "<div class='alert alert-warning' role='alert'> You are still logged in.Please <a href='account.php'> click hear </a> to proceed.</div>";
		      			}
	            ...
	            <div class="form-group">
	            	...
	            	<button type="submit" class="btn btn-primary rounded submit p-3 px-5" name=" login_botton">Get Started</button>
	            </div>
	          </form>
